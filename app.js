...
const APP = {
  ...
  async login() {
    ...
    btn.disabled = true;
    btn.innerHTML = '<span class="spinner" style="width:16px;height:16px;display:inline-block;vertical-align:middle;margin-right:8px;border:2px solid rgba(255,255,255,0.3);border-top-color:white;border-radius:50%;animation:spin 0.8s linear infinite;"></span> Signing in…';
  ...
  showTab(tabId) {
    ...
    switch(tabId) {
      ...
      case "stores": STORES.render(); break;
      case "critical": CRITICAL.render(); break;
      case "reports": REPORTS.render(); break;
      case "engineers": ENGINEERS.render(); break;
  ...
  async showNotifications() {
    ...
    if (!panel.classList.contains("hidden")) {
      try {
        ...
        NOTIF.renderList(data.notifications || []);
      } catch (e) {
...
const CRITICAL = {
  render() {
    document.getElementById("contentArea").innerHTML =
      "<div class='card'><h2>Critical</h2></div>";
  }
};
...
const REPORTS = {
  render() {
    document.getElementById("contentArea").innerHTML =
      "<div class='card'><h2>Reports</h2></div>";
  }
};
...
const ENGINEERS = {
  render() {
    document.getElementById("contentArea").innerHTML =
      "<div class='card'><h2>Engineers</h2></div>";
  }
};
...
const ALERTS = {
  render() {
    document.getElementById("contentArea").innerHTML =
      "<div class='card'><h2>Alerts</h2></div>";
  }
};
...
const HISTORY = {
  render() {
    document.getElementById("contentArea").innerHTML =
      "<div class='card'><h2>History</h2></div>";
  }
};
...
const ADMIN = {
  render() {
    document.getElementById("contentArea").innerHTML =
      "<div class='card'><h2>Admin</h2></div>";
  }
};
